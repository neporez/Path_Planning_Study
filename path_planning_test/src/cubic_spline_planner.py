...
def main():
    ...
    manhae1 = np.load(file='/home/mommae/catkin_ws/src/seoya_anything/path/seoya_test2_0.5.npy')
...
def seoya_mapping():
    manhae1 = np.load(file='/home/macaron/catkin_ws/src/macaron_3/path/npy_file/path/MH_ld.npy')
    x = manhae1[0:manhae1.shape[0]-1, 0]
    y = manhae1[0:manhae1.shape[0]-1, 1]
    
    rx, ry, ryaw, rk, rdk, s = calc_spline_course(x, y, 0.5)
    r = []
    for i in range(len(rx)):
        r.append([rx[i], ry[i]])
    print(r)

    np.save('/home/macaron/catkin_ws/src/macaron_3/path/npy_file/path/MH_ld_2.npy', r)
